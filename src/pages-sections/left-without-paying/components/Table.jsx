...
const DataListTable = ({ datalist, tableHeading }) => {
  ...
  const handlePersonalModalOpen = idNo => {
  ...
  return (
    <>
              ...
              {filteredData && filteredData.length > 0 ? (
                filteredData.map(data => (
                  <StyledTableRow key={data.email}>
                    ...
                    <StyledTableCell align="center" rowSpan={1}>
                      <Button
                        onClick={() => handlePersonalModalOpen(data.idNo)}
                      >
                        Personal Details
                      </Button>
                    </StyledTableCell>
      ...
      <Dialog open={isPersonalModalOpen} onClose={handlePersonalModalClose}>
        ...
        {requiredDoc && (
          <>
            ...
            <DialogContentText>
              Room Left Date:{requiredDoc.endDate}
            </DialogContentText>
          </>
        )}
      </Dialog>
